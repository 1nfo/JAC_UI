...
/***/ function(module, exports, __webpack_require__) {
	...
	var toggleButton = React.createElement(
	    "a",
	    { href: "#menu-toggle", className: "btn btn-default", id: "menu-toggle", style: { display: "none" } },
	    "Toggle"
	);
	...
	var jacConfigPopup = React.createElement(
	    "div",
	    { id: "jac_config_area" },
	    React.createElement(
	        "button",
	        { className: "jac_configJson_open" },
	        "Configuration Json"
	    ),
	    React.createElement(
	        "div",
	        { id: "jac_configJson" },
	        React.createElement("textarea", { cols: "100", rows: "25", id: "jac_config_testArea" }),
	        React.createElement("br", null),
	        React.createElement(
	            "button",
	            { id: "jac_config_save" },
	        ...
	        React.createElement(
	            "button",
	            { className: "jac_configJson_close" },
	            "close"
	        )
	    )
	);
