...
/***/ function(module, exports, __webpack_require__) {
	...
	var _JacConfigPopup = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputBlock_startTask = React.createElement(
	    "div",
	    ...
	    React.createElement(
	        ...
	        React.createElement(
	            "a",
	            { href: "#", className: "btn btn-default", id: "btn_createTask" },
	            "create"
	        ),
	        React.createElement(
	            "a",
	            { href: "#", className: "btn btn-default", id: "btn_resumeTask" },
	            "resume"
	        )
	    )
	);

	var InputBlock_taskInfo = React.createElement(
	    "div",
	    { id: "InputBlock_taskInfo" },
	    React.createElement(
	        "div",
	        { className: "row panel", id: "InputRow_task", style: { display: "none" } },
	        React.createElement(
	            "div",
	            { className: "col-md-3" },
	            React.createElement(
	        ...
	        React.createElement(
	            "div",
	            { className: "col-md-3" },
	            React.createElement("input", { id: "jac_taskName" })
	        ),
	        React.createElement(
	            "div",
	            { className: "col-md-1", id: "cleaup_btn_div", style: { display: "none" } },
	            React.createElement(
	                "a",
	                { href: "#", className: "btn btn-default btn-sm", id: "btn_cleanupTask" },
	                "Del Task"
	            )
	        )
	    ),
	    React.createElement(
	        "div",
	        { className: "row panel", id: "InputRow_slaveNem", style: { display: "none" } },
	        React.createElement(
	            "div",
	            { className: "col-md-3" },
	            React.createElement(
	        ...
	        React.createElement(
	            "div",
	            { className: "col-md-3" },
	            React.createElement("input", { id: "jac_slaveNum" })
	        )
	    ),
	    React.createElement(
	        "div",
	        ...
	        React.createElement(
	            "div",
	            { className: "col-md-1" },
	            React.createElement("input", { id: "jac_taskID" })
	        )
	    ),
	    React.createElement("div", { className: "row panel", id: "InputRow_resumeTasks", style: { display: "none" } }),
	    React.createElement(
	        "div",
	        { className: "row panel", id: "InputRow_confirmBtn", style: { display: "none" } },
	        React.createElement(
	            "a",
	            { href: "#", className: "btn btn-default", id: "btn_taskConfirm" },
	            "confirm"
	        )
	    )
	);

	var InputBlock_uploadFiles = React.createElement(
	    "div",
	    { id: "InputBlock_uploadFiles", style: { display: "none" } },
	    React.createElement(
	        "div",
	        { className: "row panel" },
	        React.createElement(
	        ...
	        React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    "Browse",
	                    React.createElement("input", { id: "jac_uploadFiles", type: "file", name: "file", multiple: true, style: { display: "none" } })
	                ),
	                React.createElement(
	                    "a",
	                    { href: "#", className: "btn btn-default", id: "btn_uploadTask" },
	                    "Upload"
	                )
	            ),
	            React.createElement("input", { id: "uploaded_files_status", type: "text", className: "form-control col-md-1", readOnly: true })
	        )
	    )
	);

	var InputBlock_execJMX = React.createElement(
	    "div",
	    { id: "InputBlock_execJMX", style: { display: "none" } },
	    React.createElement(
	        "div",
	        { className: "row panel" },
	        React.createElement(
	        ...
	        React.createElement(
	            "div",
	            { className: "col-md-1" },
	            React.createElement("select", { id: "jac_JMXName" })
	        )
	    ),
	    React.createElement(
	        "div",
	        ...
	        React.createElement(
	            ...
	            React.createElement(
	                "a",
	                { href: "#", className: "btn btn-default", id: "btn_runTask" },
	                "run"
	            ),
	            React.createElement(
	                "a",
	                { href: "#", className: "btn btn-default disabled", id: "btn_stopRunning" },
	                "stop"
	            )
	        )
	    )
	...
	var connectionStatus = React.createElement(
	    "div",
	    { className: "row" },
	    React.createElement("span", { id: "connIcon", className: "glyphicon", "aria-hidden": "true" }),
	    "\xA0",
	    React.createElement(
	        "a",
	        { href: "#", className: "btn btn-sm btn-default", id: "btn_clear" },
	        "clear screen"
	    )
	);
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: "col-lg-6", id: "btn_op_area" },
